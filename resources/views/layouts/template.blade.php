...
<body class="template-body">
	<!--Inicio nav-->
	<!-- Insertar ./nav-bar.blade -->
	@include('components.nav-bar')
	
	<!-- TODO: pasar esto a documentación .md -->
	<!-- 'Cotent es referenciado en las siguientes vistas:
	views/avisos-de-privacidad.blade		
	views/contacto.blade		
	views/estudiantes.blade		
	views/index.blade		
	views/nab.blade		
	views/plan_estudios.blade		
	views/requisitos.blade		
	' -->
	@yield('content')
	
	
	<!-- TODO: poner el footer en otro archivo por separado -->
	<!--Inicio Footer-->
