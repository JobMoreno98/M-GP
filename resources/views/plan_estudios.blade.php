  ...
  <div class="container-fluid col-md-10">
    <div class="row d-flex">
      <div class="col-md-5 order-md-last wrap-about wrap-about d-flex align-items-stretch">
        ...
        <img class="img" src="{{asset('images/requisitos_carrusel.jpg')}}"></img>
      </div>
        ...
        <div class="modal-body col-lg-12">
          <div class="row">
            <div class="col-md-12">
              ...
              <img src="images/mapa_curricular.png" alt="" style="height: 62%; width: 100%">
              <br>
              <br>
...
<section class="ftco-gallery mt-5" id="contactanos">
